...
public class SwiftImagesPickerPlugin: NSObject, FlutterPlugin {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        if call.method=="pick" {
            ...
            self.setThemeColor(colors: theme);
            
            ac.selectImageBlock = { (images, isOriginal) in
                ...
                for (index, model) in images.enumerated() {
    ...
    private func setLanguage(configuration: ZLPhotoUIConfiguration = ZLPhotoUIConfiguration.default(), language: String) {
        switch language {
    ...
    private func setThemeColor(configuration: ZLPhotoUIConfiguration = ZLPhotoUIConfiguration.default(), colors: NSDictionary?) {
